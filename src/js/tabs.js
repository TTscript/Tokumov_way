...
const reviewsImgTablet = document.querySelector('.reviews__img-tablet');
const reviewsImgMobile = document.querySelector('.reviews__img');
...
export const tabsActive = () => {
  ...
  reviewsList.addEventListener('click', (evt) => {
    ...
    if (evt.target.textContent === 'Албания') {
      ...
      reviewsImgTablet.setAttribute('srcset', `img/reviews/albania.jpg`);
      ...
      reviewsImgTablet.setAttribute('srcset', `img/reviews/macedonia.jpg`);
      reviewsImgMobile.setAttribute('srcset', `img/reviews/macedonia-mobile.jpg`);
      ...
      reviewsImgTablet.setAttribute('srcset', `img/reviews/greece.jpg`);
      reviewsImgMobile.setAttribute('srcset', `img/reviews/greece-mobile.jpg`);
      ...
      reviewsImgTablet.setAttribute('srcset', `img/reviews/montenegro.jpg`);
      reviewsImgMobile.setAttribute('srcset', `img/reviews/montenegro-mobile.jpg`);
      ...
      reviewsImgTablet.setAttribute('srcset', `img/reviews/croatia.jpg`);
      reviewsImgMobile.setAttribute('srcset', `img/reviews/croatia-mobile.jpg`);
